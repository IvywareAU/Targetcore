...
library.** TargetCore does not build on its own: `../Msgcore` and `../Platform` are peer
directories in a parent solution that is not published alongside this repository. So a green
